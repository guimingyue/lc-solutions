...
impl Solution {
    pub fn super_pow(a: i32, b: Vec<i32>) -> i32 {
        ...
        fn my_pow(a: i32, b: i32) -> i32 {
            ...
            if b % 2 == 0 {
                let pow = my_pow(a, b / 2);
                return (pow * pow) % MOD;
            } else {
                let pow = my_pow(a, (b-1) / 2);
                return ((a % MOD) * ((pow * pow) % MOD)) % MOD;
            }
        }

        fn super_pow(a: i32, mut stack: Vec<i32>) -> i32{
            if let Some(b) = stack.pop() {
                let pow1 = my_pow(a, b);
                let pow2 = my_pow(super_pow(a, stack), 10);
                (pow1 * pow2) % MOD
            } else {
                1
            }
